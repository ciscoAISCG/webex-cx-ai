...
|---|---|
| [Appointment_Scheduling](Appointment_Scheduling/README.md) | Autonomous voice AI agent that helps callers book a new appointment, review existing appointments, and reschedule using backend-driven slot availability and Webex Connect fulfillment. |
...
| [Procedure_Guided_Agent_Pattern](Procedure_Guided_Agent_Pattern/README.md) | Cross-industry AI agent pattern that selects an approved procedure from a bounded catalogue, retrieves full guidance by `procedure_id`, and then acts safely using authoritative facts and neutral fulfillment outcomes. |
