...
|---|---|
| [Appointment_Scheduling](https://github.com/ciscoAISCG/webex-cx-ai/blob/main/Playbooks/Appointment_Scheduling/README.md) | Autonomous voice AI agent that helps callers book a new appointment, review existing appointments, and reschedule using backend-driven slot availability and Webex Connect fulfillment. |
...
| [Order_Tracking](https://github.com/ciscoAISCG/webex-cx-ai/blob/main/Playbooks/Order_Tracking/README.md) | Autonomous voice AI agent that uses one backend lookup contract to answer order-status, delivery, delay, and tracking-progress questions, with trusted customer context and human escalation when needed. |
| [Procedure_Guided_Agent_Pattern](https://github.com/ciscoAISCG/webex-cx-ai/blob/main/Playbooks/Procedure_Guided_Agent_Pattern/README.md) | Cross-industry AI agent pattern that selects an approved procedure from a bounded catalogue, retrieves full guidance by `procedure_id`, and then acts safely using authoritative facts and neutral fulfillment outcomes. |
...
| [Payment_AI_Agent_Scripted](https://github.com/ciscoAISCG/webex-cx-ai/blob/main/Playbooks/Payment_AI_Agent_Scripted/README.md) | Scripted voice AI agent for hospital payment journeys, using Flow Designer state events and subflows for balance lookup and payment completion. |
...
[Install an AI SCG marketplace plugin](./Plugins/README.md#install-a-plugin) ·
[Check installed plugins for updates](./Plugins/README.md#update-my-plugins)
