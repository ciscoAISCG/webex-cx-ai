...
- `scg-playbook`: packages Webex CX AI use cases as adoption-first playbooks with Try It Fast steps, visual guidance, rounded Mermaid diagrams, Skills Shed links, customer-safe cleanup, and validation.
