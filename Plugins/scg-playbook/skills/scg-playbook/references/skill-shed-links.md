...
Skills Shed is a shared GitHub repo destination, not a local folder in the `one_drive` skill-source project.
...
- Do not create `one_drive/Skills Shed/` unless the user explicitly says the current checkout is the target GitHub repo.
