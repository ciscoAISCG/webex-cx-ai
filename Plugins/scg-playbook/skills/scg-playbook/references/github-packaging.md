...
Helper skills belong in the shared repo's `Skills Shed/<skill-name>/` folder when publishing there. Do not create that folder in the local `one_drive` skill-source project unless the user has checked out the target repo and asks for it.
